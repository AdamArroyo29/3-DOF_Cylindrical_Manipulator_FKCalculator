...
FI = LabelFrame(mygui,text="Link Lengths and Joint Variables",font=(5),bg="light green")
FI.grid(row=0,column=0)

# Link Lengths label
a1 = Label(FI,text="a1 = ",font=(10),bg="light yellow",fg="black")
a1_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
cm1 = Label(FI,text="cm",font=(10),bg="light yellow",fg="black")

a2 = Label(FI,text="a2 = ",font=(10),bg="light yellow",fg="black")
a2_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
cm2 = Label(FI,text="cm",font=(10),bg="light yellow",fg="black")

a3 = Label(FI,text="a3 = ",font=(10),bg="light yellow",fg="black")
a3_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
cm3 = Label(FI,text="cm",font=(10),bg="light yellow",fg="black")
...
T1 = Label(FI,text=" T1 = ",font=(10),bg="light yellow",fg="black")
T1_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
deg1 = Label(FI,text="deg",font=(10),bg="light yellow",fg="black")

d2 = Label(FI,text=" d2 = ",font=(10),bg="light yellow",fg="black")
d2_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
cm4 = Label(FI,text="cm",font=(10),bg="light yellow",fg="black")

d3 = Label(FI,text=" d3 = ",font=(10),bg="light yellow",fg="black")
d3_E = Entry(FI,width=5,font=(10),bg="white",fg="black")
cm5 = Label(FI,text="cm",font=(10),bg="light yellow",fg="black")
...
#Buttons Frame 
BF = LabelFrame(mygui,text="Forward Kinematics",font=(5),bg="light green")
...
PV = LabelFrame(mygui,text="Position Vectors",font=(5),bg="light green")
PV.grid(row=2,column=0)

# Position Vectors label
X = Label(PV,text="X = ",font=(10),bg="light yellow",fg="black")
X_E = Entry(PV,width=7,font=(10),bg="white",fg="black")
cm6 = Label(PV,text="cm",font=(10),bg="light yellow",fg="black")

Y = Label(PV,text="Y = ",font=(10),bg="light yellow",fg="black")
Y_E = Entry(PV,width=7,font=(10),bg="white",fg="black")
cm7 = Label(PV,text="cm",font=(10),bg="light yellow",fg="black")

Z = Label(PV,text="Z = ",font=(10),bg="light yellow",fg="black")
Z_E = Entry(PV,width=7,font=(10),bg="white",fg="black")
cm8 = Label(PV,text="cm",font=(10),bg="light yellow",fg="black")
